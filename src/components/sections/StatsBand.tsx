...
const Counter = ({ stat }: { stat: Stat }) => {
  ...
  return (
    <div className="text-center px-2">
      <div className="font-display font-bold text-4xl sm:text-5xl text-primary tabular-nums">
...
export const StatsBand = () => (
  <section className="relative -mt-16 z-20">
    <div className="container-prose">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-8 gap-x-2 rounded-2xl bg-card border border-border shadow-elevated py-10 px-6 sm:px-10">
